  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
...
}</style><title>Part 2 Round 2: Dealer&#039;s Turn</title>
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411239.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait411238.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
var dealerKept4 = getValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'keptForSelf4'); // NEWSUBJECTNR SWITCHED ROLES 

// Retrieve transfer data using getValue but defining the subjectNr to specify the transfer5 from The Investor with role = 1 and NEWSUBJECTNR = 2 from the second round 
var transfer5 = getValue('decisions', 'subjectNr=2 and groupNr='+groupNr, 'transfer5'); // NEWSUBJECTNR SWITCHED ROLES 
var tripledAmount5 = transfer5 * 3;

// Record tripledAmount5 for the LLMs reference for later :) 
record('tripledAmount5', tripledAmount5); 
setValue('decisions','subjectNr=1 and subjectNr=2 and groupNr='+groupNr, 'tripledAmount5', tripledAmount5); 
...
// Set keptForSelf5 to 0 per default and record it to the database 
var keptForSelf5 = 0; 
record('keptForSelf5', keptForSelf5); 

// Record what was kept by The Investor in the second round in Part 2. What was kept by The Dealer in the second round can only be calculated after the returned5 field has been executed after the end of this stage
// Set the variable keptForSelf5 in the 'decisions' table; period is not necessary here but later for the AI loop
setValue('decisions', 'subjectNr=2 and groupNr='+groupNr, 'keptForSelf5', investorKept5); // NEWSUBJECTNR SWITCHED ROLES</script><!-- END Element 2 Type: 19-->
...
setTimeout(function() {
    window.location.href = "https://app.prolific.com/submissions/complete?cc=CC6I7R7J";
        ...
        <script>// Hide the timer if transfer5 == 0 
$(document).ready(function() {
    if (transfer5 == 0) {
...
if (transfer5 == 0) {
    var returned5 = 0; 
    setValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'returned5', returned5); // NEWSUBJECTNR SWITCHED ROLES 
    
    setTimeout(function() {
        let currentUrl = window.location.href;
        let newUrl = currentUrl.replace(/stage\d+/i, "stage411239");
        window.location.href = newUrl;
    }, 20000);
...
<h1 style="text-align: right;">Part 2 | Round 2 of 3</h1>
...
<p style="text-align: right; font-size: larger;">In 20 seconds, you will be automatically re-directed to the next round, keeping your current credit.<br></p>
        ...
        </div><script>if((role==2 && transfer5 == 0)) { $('#wrap6').show(); } </script><!-- END Element 6 Type: 1-->
...
<h3 style="text-align: right;"><br></h3>
<div style="text-align: left;">
<h1 style="text-align: right;">Part 2 | Round 2 of 3: Your turn!</h1>
<p style="text-align: right; font-size: larger;"><i>The Investor</i> has <b>invested <script>document.write(transfer5)</script> coins </b> in this round.</p>
<p style="text-align: right;"><span style="background-color: rgba(223, 240, 216, 0); font-size: 16.8px;">As part of the game, the amount was tripled to<b> <script>document.write(tripledAmount5)</script> coins for the shared pot.</b></span></p><p style="text-align: right;"><i style="font-size: larger; background-color: rgba(223, 240, 216, 0);">The Investor</i><span style="font-size: larger; background-color: rgba(223, 240, 216, 0);"> has currently <script>document.write(investorKept5)</script> coins left in this round.</span><br></p>
<p style="text-align: right; font-size: larger;">Now, it&#039;s your time to shine.&nbsp;</p><p style="text-align: right; font-size: larger;"><b>How much will you give back?</b></p>
        ...
        </div><script>if((role==2 && transfer5 > 0 && transfer5 != 1)) { $('#wrap7').show(); } </script><!-- END Element 7 Type: 1-->
...
<div style="text-align: left;">
<h1 style="text-align: right;">Part 2 | Round 2 of 3: Your turn!</h1>
<p style="text-align: right; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer5)</script> coin </b>in this round.</p>
<p style="text-align: right; font-size: larger;">As part of the game, the amount was tripled to<b> <script>document.write(tripledAmount5)</script> coins for the shared pot.</b></p>
<p style="text-align: right; font-size: larger;"><i>The Investor</i> has currently <script>document.write(investorKept5)</script> coins left in this round.</p>
...
<p style="text-align: right; font-size: larger;"><b>How much will you give back?</b></p>
        ...
        </div><script>if((role==2 && transfer5 == 1)) { $('#wrap8').show(); } </script><!-- END Element 8 Type: 1-->
...
<p style="text-align: right; margin-right: 100px;"><iframe src="https://botsi-trust-game-llama-2-13b-chat.hf.space" frameborder="0" width="1050" height="550" style="background-color: rgba(223, 240, 216, 0);"></iframe></p></div>
        ...
        <div class="col-sm-12" id="wrap10" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field10"><p style="font-size: larger;">You can give back&nbsp;<b style="color: rgb(247, 150, 70);">up to <script>document.write(tripledAmount5)</script> coins.</b></p></label><input name="10" id="field10"
                            ...
                            onchange="returned5=parseFloat(this.value);"
                            class="form-control input-lg" style="text-align: center;"><div id="field10_minmax" class=" messagefield10 alert alert-danger" style="display: none;">Please enter a number between 0 and <script>document.write(tripledAmount5)</script>.</div><div id="field10_noNumber" class="messagefield10 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field10_tooManyDigits" class="messagefield10 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field10_notcorrect" class="messagefield10 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var returned5=null;function checkValue_field10() {
           var label="returned5";var min=0;var max=tripledAmount5;var digits=0;var correct=null;var required=1;var inline=1;var label1=null;var label2=null;
            if(!(role==2 && transfer5 > 0)) { checker=checker+1; } else {
            
                var value;
                if (bot) { 
                    if (correct != null) { value = correct; }
                    else if (typeof bot_returned5 !== 'undefined') { value=bot_returned5; }
               ...
               if (allcorrect!=checker) {
                  wronganswers['returned5']=1;
                  totalwronganswers['returned5'] = isNaN(totalwronganswers['returned5']) ? 1 : totalwronganswers['returned5']+1; 
                } else wronganswers['returned5']=0;
            }

}

        </script></div></div></div><script>if((role==2 && transfer5 > 0)) { $('#wrap10').show(); } </script><!-- END Element 10 Type: 20-->
        ...
        function checkFail() {}function toNextPage11() {showNext('wait411238.php?session_index=<?php echo $_SESSION[sessionID];?>&next=411239&jump=0',411239,411238)}</script></div><script>if((role==2 && transfer5 > 0)) { $('#wrap11').show(); $('#buttonclick11').addClass('buttonclick');} </script><!-- END Element 11 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==2 && transfer5 == 0) $('#wrap6').show();if (!(role==2 && transfer5 == 0)) $('#wrap6').hide();if (role==2 && transfer5 > 0 && transfer5 != 1) $('#wrap7').show();if (!(role==2 && transfer5 > 0 && transfer5 != 1)) $('#wrap7').hide();if (role==2 && transfer5 == 1) $('#wrap8').show();if (!(role==2 && transfer5 == 1)) $('#wrap8').hide();if (role==2 && transfer5 > 0) $('#wrap9').show();if (!(role==2 && transfer5 > 0)) $('#wrap9').hide();if (role==2 && transfer5 > 0) $('#wrap10').show();if (!(role==2 && transfer5 > 0)) $('#wrap10').hide();if (role==2 && transfer5 > 0) $('#wrap11').show();if (!(role==2 && transfer5 > 0)) $('#wrap11').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage411244.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>