  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411238.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait411237.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
<h1 style="text-align: center;">Part 2 | Round 2 of 3: Your turn!</h1>
<p style="text-align: center; font-size: larger;">You are still in the role of <i>The Investor. </i></p>
<p style="text-align: center; font-size: larger;">In the last round, <i>The Dealer </i>returned&nbsp;<script>document.write(returned4)</script> out of <script>document.write(tripledAmount4)</script> coins to you and kept <script>document.write(dealerKept4)</script> coins.</p><p style="text-align: center; font-size: larger;">Your total in Round 1 was <script>document.write(investorRound4)</script> coins.</p>
<p style="text-align: center; font-size: larger;"><b>How much money do you want to invest to the shared pot? </b></p>
<p style="text-align: center; font-size: larger;">The invested amount will be tripled automatically.</p><p style="text-align: center; font-size: larger;"><i>The Dealer</i> decides how this tripled amount will be split among the two of you.</p>
</div></div>
        ...
        function checkFail() {}function toNextPage8() {showNext('wait411237.php?session_index=<?php echo $_SESSION[sessionID];?>&next=411238&jump=0',411238,411237)}</script></div><script>if((role==1)) { $('#wrap8').show(); $('#buttonclick8').addClass('buttonclick');} </script><!-- END Element 8 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==1 && transfer4 == 0) $('#wrap5').show();if (!(role==1 && transfer4 == 0)) $('#wrap5').hide();if (role==1 && transfer4 > 0) $('#wrap6').show();if (!(role==1 && transfer4 > 0)) $('#wrap6').hide();if (role==1) $('#wrap7').show();if (!(role==1)) $('#wrap7').hide();if (role==1) $('#wrap8').show();if (!(role==1)) $('#wrap8').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage411244.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>