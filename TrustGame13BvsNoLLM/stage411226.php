  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411227.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait411226.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
<h3 style="text-align: right;"><br></h3></div>
        ...
        function checkFail() {} function toNextPage5() {
            if (loopEnd==411226) { showNext('wait411226.php?session_index=<?php echo $_SESSION[sessionID];?>',411227,411226);}
            else {showNext('stage411227.php?session_index=<?php echo $_SESSION[sessionID];?>',411227,411226);}
