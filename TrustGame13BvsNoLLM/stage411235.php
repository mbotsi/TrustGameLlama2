  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
...
}</style><title>Part 2 Round 1: Investor&#039;s Turn</title>
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411236.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait411235.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
<p style="text-align: center; font-size: larger;"><i>The Dealer</i> decides how this tripled amount will be split among the two of you.</p>
        ...
        <div class="col-sm-12" id="wrap6" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field6"><p style="font-size: larger;">You can invest&nbsp;<b style="color: rgb(247, 150, 70);">up to 10 coins.</b></p></label><input name="6" id="field6"
                            ...
                            onchange="transfer4=parseFloat(this.value);"
                            class="form-control input-lg" style="text-align: center;"><div id="field6_minmax" class=" messagefield6 alert alert-danger" style="display: none;">Please enter a number between 0 and 10.</div><div id="field6_noNumber" class="messagefield6 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field6_tooManyDigits" class="messagefield6 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field6_notcorrect" class="messagefield6 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var transfer4=null;function checkValue_field6() {
           var label="transfer4";var min=0;var max=10;var digits=0;var correct=null;var required=1;var inline=1;var label1=null;var label2=null;
            if(!(role==1)) { checker=checker+1; } else {
            
                var value;
                if (bot) { 
                    if (correct != null) { value = correct; }
                    else if (typeof bot_transfer4 !== 'undefined') { value=bot_transfer4; }
               ...
               if (allcorrect!=checker) {
                  wronganswers['transfer4']=1;
                  totalwronganswers['transfer4'] = isNaN(totalwronganswers['transfer4']) ? 1 : totalwronganswers['transfer4']+1; 
                } else wronganswers['transfer4']=0;
            }
        ...
        function checkFail() {}function toNextPage7() {showNext('wait411235.php?session_index=<?php echo $_SESSION[sessionID];?>&next=411236&jump=0',411236,411235)}</script></div><script>if((role==1)) { $('#wrap7').show(); $('#buttonclick7').addClass('buttonclick');} </script><!-- END Element 7 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==1) $('#wrap5').show();if (!(role==1)) $('#wrap5').hide();if (role==1) $('#wrap6').show();if (!(role==1)) $('#wrap6').hide();if (role==1) $('#wrap7').show();if (!(role==1)) $('#wrap7').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage411244.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>