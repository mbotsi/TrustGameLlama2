  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
...
}</style><title>Redirect to Prolific - Dropout Lobby</title>
        ...
        function skipStage(proceedifpossible) {
         ...
         else location.replace('wait411246.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
setTimeout(function() {
    window.location.href = "https://app.prolific.com/submissions/complete?cc=C5NCQ779";
...
<h1><b>Unfortunately the game couldn&#039;t start because of missing players.</b></h1><h1><b>You are now being redirected to Prolific.</b></h1></div>
