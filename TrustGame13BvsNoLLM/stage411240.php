  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411241.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait411240.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
setValue('decisions', 'subjectNr=2 and groupNr='+groupNr, 'keptForSelf6', investorKept6); // NEWSUBJECTNR SWITCHED ROLES</script><!-- END Element 2 Type: 19-->
...
if (transfer6 == 0) {
    ...
    setTimeout(function() {
        let currentUrl = window.location.href;
        let newUrl = currentUrl.replace(/stage\d+/i, "stage411241");
        window.location.href = newUrl;
    }, 20000);
...
<h3 style="text-align: right;"><br></h3>
<div style="text-align: left;">
<h1 style="text-align: right;">Part 2 | Round 3 of 3: Your turn!</h1>
<p style="text-align: right; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer6)</script> coins </b>in this round.</p>
<p style="text-align: right;"><span style="background-color: rgba(223, 240, 216, 0); font-size: 16.8px;">As part of the game, the amount was tripled to <b><script>document.write(tripledAmount6)</script> coins for the shared pot.</b></span></p><p style="text-align: right;"><i style="font-size: larger; background-color: rgba(223, 240, 216, 0);">The Investor</i><span style="font-size: larger; background-color: rgba(223, 240, 216, 0);"> has currently <script>document.write(investorKept6)</script> coins left in this round.&nbsp;</span><br></p>
...
<div style="text-align: left;">
<h1 style="text-align: right;">Part 2 | Round 3 of 3: Your turn!</h1>
<p style="text-align: right; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer6)</script> coin </b>in this round.</p>
<p style="text-align: right; font-size: larger;">As part of the game, the amount was tripled to <b><script>document.write(tripledAmount6)</script> coins for the shared pot.</b></p>
<p style="text-align: right; font-size: larger;"><i>The Investor</i> has currently <script>document.write(investorKept6)</script> coins left in this round.</p>
...
<p style="text-align: right; margin-right: 100px;"><iframe src="https://botsi-trust-game-llama-2-13b-chat.hf.space" frameborder="0" width="1050" height="550" style="background-color: rgba(223, 240, 216, 0);"></iframe></p></div>
        ...
        <div class="col-sm-12" id="wrap10" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field10"><p style="font-size: larger;">You can give back&nbsp;<b style="color: rgb(247, 150, 70);">up to <script>document.write(tripledAmount6)</script> coins.</b></p></label><input name="10" id="field10"
                            ...
                            class="form-control input-lg" style="text-align: center;"><div id="field10_minmax" class=" messagefield10 alert alert-danger" style="display: none;">Please enter a number between 0 and <script>document.write(tripledAmount6)</script>.</div><div id="field10_noNumber" class="messagefield10 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field10_tooManyDigits" class="messagefield10 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field10_notcorrect" class="messagefield10 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var returned6=null;function checkValue_field10() {
        ...
        </script></div></div></div><script>if((role==2 && transfer6 > 0)) { $('#wrap10').show(); } </script><!-- END Element 10 Type: 20-->
        ...
        function checkFail() {}function toNextPage11() {showNext('wait411240.php?session_index=<?php echo $_SESSION[sessionID];?>&next=411241&jump=0',411241,411240)}</script></div><script>if((role==2 && transfer6 > 0)) { $('#wrap11').show(); $('#buttonclick11').addClass('buttonclick');} </script><!-- END Element 11 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==2 && transfer6 == 0) $('#wrap5').show();if (!(role==2 && transfer6 == 0)) $('#wrap5').hide();if (role==2 && transfer6 > 0 && transfer6 != 1) $('#wrap7').show();if (!(role==2 && transfer6 > 0 && transfer6 != 1)) $('#wrap7').hide();if (role==2 && transfer6 == 1) $('#wrap8').show();if (!(role==2 && transfer6 == 1)) $('#wrap8').hide();if (role==2 && transfer6 > 0) $('#wrap9').show();if (!(role==2 && transfer6 > 0)) $('#wrap9').hide();if (role==2 && transfer6 > 0) $('#wrap10').show();if (!(role==2 && transfer6 > 0)) $('#wrap10').hide();if (role==2 && transfer6 > 0) $('#wrap11').show();if (!(role==2 && transfer6 > 0)) $('#wrap11').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage411244.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>