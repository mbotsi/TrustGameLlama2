  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411233.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait411232.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
var investorKept1 = getValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'keptForSelf1');
...
<p style="text-align: right; font-size: larger;">The invested amount will automatically be tripled.</p>
<p style="text-align: right; font-size: larger;"><i>The Deale</i>r decides how this tripled amount will be split among the two of you.</p>
</div></div>
...
<h1 style="text-align: right;"> Part 1 | Round 3 of 3 : Your turn!</h1>
<p style="text-align: right; font-size: larger;">You are still in the role of <i>The Investor. </i></p>
<p style="text-align: right; font-size: larger;">In the last round, <i>The Dealer</i> returned <script>document.write(returned2)</script> out of <script>document.write(tripledAmount2)</script> coins to you and kept <script>document.write(dealerKept2)</script> coins.</p><p style="text-align: right; font-size: larger;">Your total in Round 1 was <script>document.write(investorRound2)</script> coins.</p>
<p style="text-align: right; font-size: larger;"><b>How much money do you want to invest to the shared pot? </b></p>
...
<p style="text-align: right; margin-right: 100px;"><iframe src="https://botsi-trust-game-llama-2-13b-chat.hf.space" frameborder="0" width="1050" height="550" style="background-color: rgba(223, 240, 216, 0);"></iframe></p></div>
        ...
        <div class="col-sm-12" id="wrap8" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field8"><p style="font-size: larger;">You can invest&nbsp;<b style="color: rgb(247, 150, 70);">up to 10 coins.</b></p></label><input name="8" id="field8"
                            ...
                            class="form-control input-lg" style="text-align: center;"><div id="field8_minmax" class=" messagefield8 alert alert-danger" style="display: none;">Please enter a number between 0 and 10.</div><div id="field8_noNumber" class="messagefield8 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field8_tooManyDigits" class="messagefield8 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field8_notcorrect" class="messagefield8 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var transfer3=null;function checkValue_field8() {
        ...
        function checkFail() {}function toNextPage9() {showNext('wait411232.php?session_index=<?php echo $_SESSION[sessionID];?>&next=411233&jump=0',411233,411232)}</script></div><script>if((role==1)) { $('#wrap9').show(); $('#buttonclick9').addClass('buttonclick');} </script><!-- END Element 9 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==1 && transfer2 == 0) $('#wrap5').show();if (!(role==1 && transfer2 == 0)) $('#wrap5').hide();if (role==1 && transfer2 > 0) $('#wrap6').show();if (!(role==1 && transfer2 > 0)) $('#wrap6').hide();if (role==1) $('#wrap7').show();if (!(role==1)) $('#wrap7').hide();if (role==1) $('#wrap8').show();if (!(role==1)) $('#wrap8').hide();if (role==1) $('#wrap9').show();if (!(role==1)) $('#wrap9').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage411244.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>