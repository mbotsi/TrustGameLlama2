  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411226.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait411225.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
<h3 style="text-align: right;"><br></h3></div>
        ...
        function checkFail() {} function toNextPage3() {
            if (loopEnd==411225) { showNext('wait411225.php?session_index=<?php echo $_SESSION[sessionID];?>',411226,411225);}
            else {showNext('stage411226.php?session_index=<?php echo $_SESSION[sessionID];?>',411226,411225);}
