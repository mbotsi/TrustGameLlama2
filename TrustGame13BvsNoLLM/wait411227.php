...
<head>
    ...
    function toLobby() {
        ...
        location.replace('stage411227.php?session_index=<?php echo $_SESSION[sessionID];?>');
        return false;
    }

    function toEarnings() {
        location.replace('stage411246.php?session_index=<?php echo $_SESSION[sessionID];?>');
        return false;
    }
    </script>
</head>
            ...
            <div style="padding-top: 20px">
                <div class="row">
                    ...
                    setTimeout(function() {
                        ...
                        let newUrl = currentUrl.replace(/wait.*\.php/i, "stage411246.php");
