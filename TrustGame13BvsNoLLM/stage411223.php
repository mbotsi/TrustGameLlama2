...
@media (max-width: 768px) {
  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        var prolificPID = "<?php echo $PROLIFIC_PID; ?>"; 
        pageRefreshed=0;
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411224.php?session_index=<?php echo $_SESSION[sessionID];?>&PROLIFIC_PID=<?php echo $PROLIFIC_PID;?>');
         else location.replace('wait411223.php?session_index=<?php echo $_SESSION[sessionID];?>&PROLIFIC_PID=<?php echo $PROLIFIC_PID;?>');
        }
...
<p></p></div>
        ...
        function checkFail() {} function toNextPage4() {
            if (loopEnd==411223) { showNext('wait411223.php?session_index=<?php echo $_SESSION[sessionID];?>',411224,411223);}
            else {showNext('stage411224.php?session_index=<?php echo $_SESSION[sessionID];?>',411224,411223);}
