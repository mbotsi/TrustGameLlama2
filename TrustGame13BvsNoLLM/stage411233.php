  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage411234.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait411233.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
if (transfer3 == 0) {
    ...
    setTimeout(function() {
        let currentUrl = window.location.href;
        let newUrl = currentUrl.replace(/stage\d+/i, "stage411234");
        window.location.href = newUrl;
    }, 20000);
...
<p style="text-align: center; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer3)</script> coins </b>in this round.</p>
<p style="text-align: center;"><span style="background-color: rgba(223, 240, 216, 0); font-size: 16.8px;">As part of the game, the amount was tripled to <b><script>document.write(tripledAmount3)</script> coins for the shared pot.</b></span></p><p style="text-align: center;"><i style="font-size: larger; background-color: rgba(223, 240, 216, 0);">The Investor</i><span style="font-size: larger; background-color: rgba(223, 240, 216, 0);"> has currently <script>document.write(investorKept3)</script> coins left in this round.&nbsp;</span><br></p>
...
<div style="text-align: left;">
<h1 style="text-align: center;">Part 1 | Round 3 of 3: Your turn!</h1>
<p style="text-align: center; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer3)</script> coin </b>in this round.</p>
<p style="text-align: center; font-size: larger;">As part of the game, the amount was tripled to <b><script>document.write(tripledAmount3)</script> coins for the shared pot.</b></p>
<p style="text-align: center; font-size: larger;"><i>The Investor</i> has currently <script>document.write(investorKept3)</script> coins left in this round.</p>
...
<p style="text-align: center; font-size: larger;"><b>How much will you give back?</b></p>
        ...
        <div class="col-sm-12" id="wrap9" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field9"><p style="font-size: larger;">You can give back&nbsp;<b style="color: rgb(247, 150, 70);">up to <script>document.write(tripledAmount3)</script> coins.</b></p></label><input name="9" id="field9"
                            ...
                            class="form-control input-lg" style="text-align: center;"><div id="field9_minmax" class=" messagefield9 alert alert-danger" style="display: none;">Please enter a number between 0 and <script>document.write(tripledAmount3)</script>.</div><div id="field9_noNumber" class="messagefield9 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field9_tooManyDigits" class="messagefield9 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field9_notcorrect" class="messagefield9 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var returned3=null;function checkValue_field9() {
        ...
        </script></div></div></div><script>if((role==2 && transfer3 > 0)) { $('#wrap9').show(); } </script><!-- END Element 9 Type: 20-->
