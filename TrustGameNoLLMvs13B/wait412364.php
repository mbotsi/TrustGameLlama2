...
@media (max-width: 768px) {
  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        var defNext = 412365;
        var nextPageLoop;
        if (parseInt(loopEnd)==412364) {nextPageLoop='stage'+loopStart.toString()+'.php?session_index=<?php echo $_SESSION[sessionID];?>';}
...
if (currentGroupSize < groupSize) {
    ...
    window.location.href = newUrl;
        ...
        <script>var transfer3 = getValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'transfer3');
var tripledAmount3 = transfer3 * 3;

var initialCredit = getValue('initialCredit'); 
var investorKept3 = initialCredit - transfer3;</script><!-- END Element 2 Type: 19-->
...
if (transfer3 == 0) {
    setTimeout(function() {
        let currentUrl = window.location.href;
        let newUrl = currentUrl.replace(/wait\d+\.php/i, "stage412365.php");
        window.location.href = newUrl;
    }, 20000);
...
<h1 style="text-align: center;">Part 1 | Round 3 of 3: The first part of the game is over.</h1>
<p style="text-align: center; font-size: larger;">
You have <b>not invested any coins </b>in this round. </p> 
<p style="text-align: center; font-size: larger;">
There is no amount to be tripled. This was the last round of Part 1.</p>
<p style="text-align: center; font-size: larger;">
In 20 seconds, you will be automatically re-directed to Part 2 of the game. </p>
<p style="text-align: center; font-size: larger;">
You will be taking the role of <i>The Dealer</i>, starting with a fresh credit, independent from Part 1.</p>
</div></div>
        </div><script>if((role!=2 && transfer3 == 0)) { $('#wrap4').show(); } </script><!-- END Element 4 Type: 1-->
...
<div style="text-align: left;">
<h1 style="text-align: right;">Part 1 | Round 3 of 3: Please wait.</h1>
<p style="text-align: right; font-size: larger;">Thanks for <b>investing <script>document.write(transfer3)</script> coins.&nbsp;</b></p><p style="text-align: right; font-size: larger;">Your investment has now been <b>tripled to <script>document.write(tripledAmount3)</script> coins and added to the shared pot.</b></p><p style="text-align: right; font-size: larger;">Please wait until <i>The Dealer</i> has made their decision on <b>how to distribute the money from the shared pot.</b></p>
<p style="text-align: right; font-size: larger;"><b>For now, you have <script>document.write(investorKept3)</script> coins left in this round.</b></p>
</div></div>
        </div><script>if((role!=2 && transfer3 > 0 && transfer3 != 1)) { $('#wrap5').show(); } </script><!-- END Element 5 Type: 1-->
...
<div style="text-align: left;">
<h1 style="text-align: right; ">Part 1 | Round 3 of 3: Please wait.</h1>
<p style="text-align: right; font-size: larger;">Thanks for <b>investing <script>document.write(transfer3)</script> coin.&nbsp;</b></p><p style="text-align: right; font-size: larger;">Your investment has now been <b>tripled to <script>document.write(tripledAmount3)</script> coins and added to the shared pot.</b></p>
...
<p style="text-align: right; font-size: larger;"><b>For now, you have <script>document.write(investorKept3)</script> coins left in this round.</b></p>
        ...
        </div><script>if((role!=2 && transfer3 == 1)) { $('#wrap6').show(); } </script><!-- END Element 6 Type: 1-->
...
<p>While waiting, you can play a game of Snake. <br>To play the game you need to click inside of the frame. <br>Use the arrows on your keyboard to navigate.</p></div>
        </div><script>if((role!=2 && transfer3 > 0)) { $('#wrap7').show(); } </script><!-- END Element 7 Type: 1-->
...
The game ends automatically, if <i>The Dealer</i> does not complete his task in 3 minutes.&nbsp;</span></p><p style="font-size: larger;">You will then be redirected automatically.</p></div>
        ...
        </div><script>setInterval(function(){ if (role!=2 && transfer3 == 0) $('#wrap4').show();if (!(role!=2 && transfer3 == 0)) $('#wrap4').hide();if (role!=2 && transfer3 > 0 && transfer3 != 1) $('#wrap5').show();if (!(role!=2 && transfer3 > 0 && transfer3 != 1)) $('#wrap5').hide();if (role!=2 && transfer3 == 1) $('#wrap6').show();if (!(role!=2 && transfer3 == 1)) $('#wrap6').hide();if (role!=2 && transfer3 > 0) $('#wrap7').show();if (!(role!=2 && transfer3 > 0)) $('#wrap7').hide();if (role!=2 && transfer3 > 0) $('#wrap9').show();if (!(role!=2 && transfer3 > 0)) $('#wrap9').hide(); }, 100);</script></div></form></div></div></body></html>