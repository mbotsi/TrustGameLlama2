  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         else location.replace('wait412377.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
setTimeout(function() {
    window.location.href = "https://app.prolific.com/submissions/complete?cc=C8ZLZNLN";
