...
@media (max-width: 768px) {
  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        var defNext = 412371;
        var nextPageLoop;
        if (parseInt(loopEnd)==412370) {nextPageLoop='stage'+loopStart.toString()+'.php?session_index=<?php echo $_SESSION[sessionID];?>';}
...
// Retrieve returned5 amount using getValue but defining the subjectNr to specify the returned from The Dealer
...
var dealerRound5 = 10 + dealerKept5;</script><!-- END Element 1 Type: 19-->
...
<p style="text-align: right; font-size: larger;">You are still in the role of <i>The Dealer</i>.</p><p style="text-align: right; font-size: larger;">In the last round, you returned <script>document.write(returned5)</script> out of <script>document.write(tripledAmount5)</script> coins to you and kept <script>document.write(dealerKept5)</script> coins.</p><p style="text-align: right; font-size: larger;">Your total in Round 2 was <script>document.write(dealerRound5)</script> coins, including your 10 coins starting credit.</p>
