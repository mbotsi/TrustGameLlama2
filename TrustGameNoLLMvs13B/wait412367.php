...
@media (max-width: 768px) {
  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        var defNext = 412368;
        var nextPageLoop;
        if (parseInt(loopEnd)==412367) {nextPageLoop='stage'+loopStart.toString()+'.php?session_index=<?php echo $_SESSION[sessionID];?>';}
...
if (currentGroupSize < groupSize) {
    ...
    window.location.href = newUrl;
        ...
        <script>var transfer4 = getValue('decisions', 'subjectNr=2 and groupNr='+groupNr, 'transfer4'); // NEWSUBJECTNR SWITCHED ROLES
var tripledAmount4 = transfer4 * 3;

var initialCredit = getValue('initialCredit'); 
var investorKept4 = initialCredit - transfer4;</script><!-- END Element 2 Type: 19-->
...
if (transfer4 == 0) {
    setTimeout(function() {
        let currentUrl = window.location.href;
        let newUrl = currentUrl.replace(/wait\d+\.php/i, "stage412368.php");
        window.location.href = newUrl;
    }, 20000);
...
<p style="text-align: right; font-size: larger;">In 20 seconds, you will be automatically re-directed to the next round, keeping your current credit.<br></p>
        ...
        </div><script>if((role!=2 && transfer4 == 0)) { $('#wrap4').show(); } </script><!-- END Element 4 Type: 1-->
...
<p style="text-align: right; font-size: larger;"> Thanks for <b>investing <script>document.write(transfer4)</script> coins.&nbsp;</b></p><p style="text-align: right; font-size: larger;">Your investment has now been <b>tripled to <script>document.write(tripledAmount4)</script> coins and added to the shared pot.</b></p>
...
<p style="text-align: right; font-size: larger;"><b>For now, you have <script>document.write(investorKept4)</script> coins left in this round.</b></p>
</div></div>
        </div><script>if((role!=2 && transfer4 > 0 && transfer4 != 1)) { $('#wrap5').show(); } </script><!-- END Element 5 Type: 1-->
...
<div style="text-align: left;">
<h1 style="text-align: right; ">Part 2 | Round 1 of 3: Please wait.</h1>
<p style="text-align: right; font-size: larger;"> Thanks for <b>investing <script>document.write(transfer4)</script> coin.&nbsp;</b></p><p style="text-align: right; font-size: larger;">Your investment has now been <b>tripled to <script>document.write(tripledAmount4)</script> coins and added to the shared pot.</b></p>
<p style="text-align: right; font-size: larger;">Please wait until <i>The Dealer</i> has made their decision on <b>how to distribute the money from the shared pot.</b></p>
<p style="text-align: right; font-size: larger;"><b>For now, you have <script>document.write(investorKept4)</script> coins left in this round.</b></p>
</div></div>
        </div><script>if((role!=2 && transfer4 == 1)) { $('#wrap6').show(); } </script><!-- END Element 6 Type: 1-->
...
The game ends automatically, if <i>The Dealer</i> does not complete his task in 3 minutes.&nbsp;</span></p><p style="font-size: larger;">You will then be redirected automatically.</p></div>
        </div><script>if((role!=2 && transfer4 > 0)) { $('#wrap10').show(); } </script><!-- END Element 10 Type: 1-->
        
        </div><script>setInterval(function(){ if (role!=2 && transfer4 == 0) $('#wrap4').show();if (!(role!=2 && transfer4 == 0)) $('#wrap4').hide();if (role!=2 && transfer4 > 0 && transfer4 != 1) $('#wrap5').show();if (!(role!=2 && transfer4 > 0 && transfer4 != 1)) $('#wrap5').hide();if (role!=2 && transfer4 == 1) $('#wrap6').show();if (!(role!=2 && transfer4 == 1)) $('#wrap6').hide();if (role!=2 && transfer4 > 0) $('#wrap9').show();if (!(role!=2 && transfer4 > 0)) $('#wrap9').hide();if (role!=2 && transfer4 > 0) $('#wrap10').show();if (!(role!=2 && transfer4 > 0)) $('#wrap10').hide(); }, 100);</script></div></form></div></div></body></html>