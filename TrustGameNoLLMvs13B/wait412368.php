...
@media (max-width: 768px) {
  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        var defNext = 412369;
        var nextPageLoop;
        if (parseInt(loopEnd)==412368) {nextPageLoop='stage'+loopStart.toString()+'.php?session_index=<?php echo $_SESSION[sessionID];?>';}
...
// Retrieve returned4 amount using getValue but defining the subjectNr to specify the returned from The Dealer 
...
var dealerRound4 = 10 + dealerKept4;</script><!-- END Element 1 Type: 19-->
...
<p style="text-align: right; font-size: larger;">You are still in the role of <i>The Dealer</i>.</p><p style="text-align: right; font-size: larger;">In the last round, you returned <script>document.write(returned4)</script> out of <script>document.write(tripledAmount4)</script> coins to you and kept <script>document.write(dealerKept4)</script> coins.</p><p style="text-align: right; font-size: larger;">Your total in Round 1 was <script>document.write(dealerRound4)</script> coins, including your 10 coins starting credit.</p><p style="text-align: right; font-size: larger;"><span style="font-weight: bold;">Please wait until <i>The Investor</i> has made their decision on how much to invest into the shared pot in Round 2.</span></p><p style="text-align: right; font-size: larger;">
