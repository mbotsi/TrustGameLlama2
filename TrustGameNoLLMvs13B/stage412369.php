  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage412370.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait412369.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
setValue('decisions', 'subjectNr=2 and groupNr='+groupNr, 'keptForSelf5', investorKept5); // NEWSUBJECTNR SWITCHED ROLES 
setValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'keptForSelf5', dealerKept5); // NEWSUBJECTNR SWITCHED ROLES</script><!-- END Element 2 Type: 19-->
...
if (transfer5 == 0) {
    ...
    setTimeout(function() {
        let currentUrl = window.location.href;
        let newUrl = currentUrl.replace(/stage\d+/i, "stage412370");
        window.location.href = newUrl;
    }, 20000);
...
<h3 style="text-align: center;"><br></h3>
<div style="text-align: left;">
<h1 style="text-align: center;">Part 2 | Round 2 of 3: Your turn!</h1>
<p style="text-align: center; font-size: larger;"><i>The Investor</i> has <b>invested <script>document.write(transfer5)</script> coins </b> in this round.</p>
<p style="text-align: center;"><span style="background-color: rgba(223, 240, 216, 0); font-size: 16.8px;">As part of the game, the amount was tripled to<b> <script>document.write(tripledAmount5)</script> coins for the shared pot.</b></span></p><p style="text-align: center;"><i style="font-size: larger; background-color: rgba(223, 240, 216, 0);">The Investor</i><span style="font-size: larger; background-color: rgba(223, 240, 216, 0);"> has currently <script>document.write(investorKept5)</script> coins left in this round.</span><br></p>
...
<div style="text-align: left;">
<h1 style="text-align: center;">Part 2 | Round 2 of 3: Your turn!</h1>
<p style="text-align: center; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer5)</script> coin </b>in this round.</p>
<p style="text-align: center; font-size: larger;">As part of the game, the amount was tripled to<b> <script>document.write(tripledAmount5)</script> coins for the shared pot.</b></p>
<p style="text-align: center; font-size: larger;"><i>The Investor</i> has currently <script>document.write(investorKept5)</script> coins left in this round.</p>
...
<p style="text-align: center; font-size: larger;"><b>How much will you give back?</b></p>
        ...
        <div class="col-sm-12" id="wrap9" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field9"><p style="font-size: larger;">You can give back&nbsp;<b style="color: rgb(247, 150, 70);">up to <script>document.write(tripledAmount5)</script> coins.</b></p></label><input name="9" id="field9"
                            ...
                            class="form-control input-lg" style="text-align: center;"><div id="field9_minmax" class=" messagefield9 alert alert-danger" style="display: none;">Please enter a number between 0 and <script>document.write(tripledAmount5)</script>.</div><div id="field9_noNumber" class="messagefield9 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field9_tooManyDigits" class="messagefield9 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field9_notcorrect" class="messagefield9 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var returned5=null;function checkValue_field9() {
        ...
        </script></div></div></div><script>if((role==2 && transfer5 > 0)) { $('#wrap9').show(); } </script><!-- END Element 9 Type: 20-->
        ...
        function checkFail() {}function toNextPage10() {showNext('wait412369.php?session_index=<?php echo $_SESSION[sessionID];?>&next=412370&jump=0',412370,412369)}</script></div><script>if((role==2 && transfer5 > 0)) { $('#wrap10').show(); $('#buttonclick10').addClass('buttonclick');} </script><!-- END Element 10 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==2 && transfer5 == 0) $('#wrap6').show();if (!(role==2 && transfer5 == 0)) $('#wrap6').hide();if (role==2 && transfer5 > 0 && transfer5 != 1) $('#wrap7').show();if (!(role==2 && transfer5 > 0 && transfer5 != 1)) $('#wrap7').hide();if (role==2 && transfer5 == 1) $('#wrap8').show();if (!(role==2 && transfer5 == 1)) $('#wrap8').hide();if (role==2 && transfer5 > 0) $('#wrap9').show();if (!(role==2 && transfer5 > 0)) $('#wrap9').hide();if (role==2 && transfer5 > 0) $('#wrap10').show();if (!(role==2 && transfer5 > 0)) $('#wrap10').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage412375.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>