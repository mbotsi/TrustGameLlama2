  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage412368.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait412367.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
setValue('decisions', 'subjectNr=2 and groupNr='+groupNr, 'keptForSelf4', investorKept4); // NEWSUBJECTNR SWITCHED ROLES 
setValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'keptForSelf4', dealerKept4); // NEWSUBJECTNR SWITCHED ROLES</script><!-- END Element 2 Type: 19-->
...
if (transfer4 == 0) {
    ...
    setTimeout(function() {
        let currentUrl = window.location.href;
        let newUrl = currentUrl.replace(/stage\d+/i, "stage412368");
        window.location.href = newUrl;
    }, 20000);
...
<h3 style="text-align: center;"><br></h3>
<div style="text-align: left;">
<h1 style="text-align: center;">Part 2 | Round 1 of 3: Your turn!</h1>
<p style="text-align: center; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer4)</script> coins </b>in this round.</p>
<p style="text-align: center; font-size: larger;">As part of the game, the amount was tripled to<b>&nbsp;<script>document.write(tripledAmount4)</script> coins for the shared pot.</b>
</p>
<p style="text-align: center; font-size: larger;"><i>The Investor</i> has currently <script>document.write(investorKept4)</script> coins left in this round.</p>
...
<h3 style="text-align: center;"><br></h3>
<h3 style="text-align: center;"><br></h3>
<div style="text-align: left;"><h1 style="text-align: center;">Part 2 | Round 1 of 3: Your turn!</h1>
<p style="text-align: center; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer4)</script> coin </b>in this round.</p>
<p style="text-align: center; font-size: larger;">As part of the game, the amount was tripled to <b><script>document.write(tripledAmount4)</script> coins for the shared pot.</b></p>
<p style="text-align: center; font-size: larger;"><i>The Investor</i> has currently <script>document.write(investorKept4)</script> coins left in this round.</p>
<p style="text-align: center; font-size: larger;">Now, it&#039;s your time to shine.</p>
<p style="text-align: center; font-size: larger;"><b>How much will you give back?</b></p>
</div></div>
        ...
        <div class="col-sm-12" id="wrap9" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field9"><p style="font-size: larger;">You can give back&nbsp;<b style="color: rgb(247, 150, 70);">up to <script>document.write(tripledAmount4)</script> coins.</b></p></label><input name="9" id="field9"
                            ...
                            class="form-control input-lg" style="text-align: center;"><div id="field9_minmax" class=" messagefield9 alert alert-danger" style="display: none;">Please enter a number between 0 and <script>document.write(tripledAmount4)</script>.</div><div id="field9_noNumber" class="messagefield9 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field9_tooManyDigits" class="messagefield9 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field9_notcorrect" class="messagefield9 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var returned4=null;function checkValue_field9() {
        ...
        </script></div></div></div><script>if((role==2 && transfer4 > 0)) { $('#wrap9').show(); } </script><!-- END Element 9 Type: 20-->
        ...
        function checkFail() {}function toNextPage10() {showNext('wait412367.php?session_index=<?php echo $_SESSION[sessionID];?>&next=412368&jump=0',412368,412367)}</script></div><script>if((role==2 && transfer4 > 0)) { $('#wrap10').show(); $('#buttonclick10').addClass('buttonclick');} </script><!-- END Element 10 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==2 && transfer4 == 0) $('#wrap5').show();if (!(role==2 && transfer4 == 0)) $('#wrap5').hide();if (role==2 && transfer4 > 0 && transfer4 != 1) $('#wrap7').show();if (!(role==2 && transfer4 > 0 && transfer4 != 1)) $('#wrap7').hide();if (role==2 && transfer4 == 1) $('#wrap8').show();if (!(role==2 && transfer4 == 1)) $('#wrap8').hide();if (role==2 && transfer4 > 0) $('#wrap9').show();if (!(role==2 && transfer4 > 0)) $('#wrap9').hide();if (role==2 && transfer4 > 0) $('#wrap10').show();if (!(role==2 && transfer4 > 0)) $('#wrap10').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage412375.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>