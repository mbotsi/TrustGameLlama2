...
<head>
    ...
    <script>
        ...
        lobbyCheck('stage412359.php?session_index=<?php echo $_SESSION[sessionID]; ?>', 'wait412358.php?session_index=<?php echo $_SESSION[sessionID]; ?>');
    </script>
</head>
...
<body>
    <div id="mainwrap" class="container" style="width: 100%; padding-left: 5%; padding-right: 5%; padding-top: 1%;">
        <form autocomplete="off">
            <div class="row"><!-- START Element 1 Type: 1-->

                <div class="col-sm-12" id="wrap1" style="display: none;">
                    <div class="btnbox2 paddlr" style="text-align: center">
                        <h3 style="text-align: left;"><br></h3>
                        <h3 style="text-align: left;"><br></h3>
                        <h1><b style="font-family: inherit; color: rgb(247, 150, 70);">Please wait until another player is ready.</b></h1>
                        <h1><b style="color: inherit; font-family: inherit;">If nobody joins during the next 5 minutes, we will redirect you to Prolific.&nbsp;<br></b><b style="color: inherit; font-family: inherit;">Thank you for your understanding.</b></h1>
                        <h3 style="text-align: left;"><br></h3>
                        <h3 style="text-align: left;"><br></h3>
                    </div>
                </div>
                ...
                </script><!-- END Element 1 Type: 1-->

            </div>

            <div class="row" id="waitingForContainer">
                <div id="waitingFor" style="text-align: center;"> </div>
            </div>
            ...
            <script>
                ...
                countdownTimer(lobbyTimeout, 'wait412358.php?session_index=<?php echo $_SESSION[sessionID]; ?>', true);
