  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
...
}</style><title>Part 2 Round 2: Investor&#039;s Turn</title>
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage412369.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait412368.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
// Retrieve returned4 amount using getValue but defining the subjectNr to specify the returned4 from The Dealer with role = 2 andNEWSUBJECTNR = 1 from the first round 
var returned4 = getValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'returned4'); // NEWSUBJECTNR SWITCHED ROLES 

// Calculate what The Dealer kept to himself in the first round in Part 2 
var dealerKept4 = tripledAmount4 - returned4; 

// Record what was kept by The Dealer after the first round in Part 2
// Set the variable keptForSelf4 in the 'decisions' table; period is not necessary here but later for the AI loop
setValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'keptForSelf4', dealerKept4);  // NEWSUBJECTNR SWITCHED ROLES 

// Set totalRound4 to 0 per default and record it to the database 
var totalRound4 = 0; 
record('totalRound4', totalRound4); 

var dealerRound4 = 10 + dealerKept4; 
setValue('decisions', 'subjectNr=1 and groupNr='+groupNr, 'totalRound4', dealerRound4);  // NEWSUBJECTNR SWITCHED ROLES 
var investorRound4 = investorKept4 + returned4; 
setValue('decisions', 'subjectNr=2 and groupNr='+groupNr, 'totalRound4', investorRound4);  // NEWSUBJECTNR SWITCHED ROLES</script><!-- END Element 2 Type: 19-->
...
<p style="text-align: right; font-size: larger;">The invested amount will be tripled automatically.</p><p style="text-align: right; font-size: larger;"><i>The Dealer</i> decides how this tripled amount will be split among the two of you.</p>
        ...
        </div><script>if((role==1 && transfer4 == 0)) { $('#wrap5').show(); } </script><!-- END Element 5 Type: 1-->
...
<h1 style="text-align: right;">Part 2 | Round 2 of 3: Your turn!</h1>
<p style="text-align: right; font-size: larger;">You are still in the role of <i>The Investor. </i></p>
<p style="text-align: right; font-size: larger;">In the last round, <i>The Dealer </i>returned&nbsp;<script>document.write(returned4)</script> out of <script>document.write(tripledAmount4)</script> coins to you and kept <script>document.write(dealerKept4)</script> coins.</p><p style="text-align: right; font-size: larger;">Your total in Round 1 was <script>document.write(investorRound4)</script> coins.</p>
<p style="text-align: right; font-size: larger;"><b>How much money do you want to invest to the shared pot? </b></p>
<p style="text-align: right; font-size: larger;">The invested amount will be tripled automatically.</p><p style="text-align: right; font-size: larger;"><i>The Dealer</i> decides how this tripled amount will be split among the two of you.</p>
</div></div>
        </div><script>if((role==1 && transfer4 > 0)) { $('#wrap6').show(); } </script><!-- END Element 6 Type: 1-->
...
<p style="text-align: right; margin-right: 100px;"><iframe src="https://botsi-trust-game-llama-2-13b-chat.hf.space" frameborder="0" width="1050" height="550" style="background-color: rgba(223, 240, 216, 0);"></iframe></p></div>
        ...
        <div class="col-sm-12" id="wrap8" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field8"><p style="font-size: larger;">You can invest&nbsp;<b style="color: rgb(247, 150, 70);">up to 10 coins.</b></p></label><input name="8" id="field8"
                            ...
                            onchange="transfer5=parseFloat(this.value);"
                            class="form-control input-lg" style="text-align: center;"><div id="field8_minmax" class=" messagefield8 alert alert-danger" style="display: none;">Please enter a number between 0 and 10.</div><div id="field8_noNumber" class="messagefield8 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field8_tooManyDigits" class="messagefield8 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field8_notcorrect" class="messagefield8 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var transfer5=null;function checkValue_field8() {
           var label="transfer5";var min=0;var max=10;var digits=0;var correct=null;var required=1;var inline=1;var label1=null;var label2=null;
            if(!(role==1)) { checker=checker+1; } else {
            
                var value;
                if (bot) { 
                    if (correct != null) { value = correct; }
                    else if (typeof bot_transfer5 !== 'undefined') { value=bot_transfer5; }
               ...
               if (allcorrect!=checker) {
                  wronganswers['transfer5']=1;
                  totalwronganswers['transfer5'] = isNaN(totalwronganswers['transfer5']) ? 1 : totalwronganswers['transfer5']+1; 
                } else wronganswers['transfer5']=0;
            }
        ...
        function checkFail() {}function toNextPage9() {showNext('wait412368.php?session_index=<?php echo $_SESSION[sessionID];?>&next=412369&jump=0',412369,412368)}</script></div><script>if((role==1)) { $('#wrap9').show(); $('#buttonclick9').addClass('buttonclick');} </script><!-- END Element 9 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==1 && transfer4 == 0) $('#wrap5').show();if (!(role==1 && transfer4 == 0)) $('#wrap5').hide();if (role==1 && transfer4 > 0) $('#wrap6').show();if (!(role==1 && transfer4 > 0)) $('#wrap6').hide();if (role==1) $('#wrap7').show();if (!(role==1)) $('#wrap7').hide();if (role==1) $('#wrap8').show();if (!(role==1)) $('#wrap8').hide();if (role==1) $('#wrap9').show();if (!(role==1)) $('#wrap9').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage412375.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>