  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage412373.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait412372.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
<h1 style="text-align: left; "><strong>Part 4</strong></h1><p style="text-align: left; font-size: larger;">How would you evaluate the <b>decision making with the support of a chatbot</b>?</p></div>
        </div><script>if((role==1)) { $('#wrap46').show(); } </script><!-- END Element 46 Type: 1-->
        ...
        </script></div><script>if((role==1)) { $('#wrap47').show(); } </script><!-- END Element 47 Type: 23-->
        ...
        </script></div><script>if((role==1)) { $('#wrap48').show(); } </script><!-- END Element 48 Type: 23-->
        ...
        </script></div><script>if((role==1)) { $('#wrap49').show(); } </script><!-- END Element 49 Type: 23-->
        ...
        </script></div><script>if((role==1)) { $('#wrap50').show(); } </script><!-- END Element 50 Type: 23-->
        ...
        </script></div><script>if((role==1)) { $('#wrap51').show(); } </script><!-- END Element 51 Type: 23-->
        ...
        </script></div><script>if((role==1)) { $('#wrap52').show(); } </script><!-- END Element 52 Type: 23-->
