...
@media (max-width: 768px) {
  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        var defNext = 412364;
        var nextPageLoop;
        if (parseInt(loopEnd)==412363) {nextPageLoop='stage'+loopStart.toString()+'.php?session_index=<?php echo $_SESSION[sessionID];?>';}
...
// Retrieve returned1 amount using getValue but defining the subjectNr to specify the returned2 from The Dealer with role = 2 and subjectNr = 2 from the first round 
...
var dealerRound2 = 10 + dealerKept2;</script><!-- END Element 1 Type: 19-->
...
<p style="text-align: right; font-size: larger;">You are still in the role of <i>The Dealer</i>.</p><p style="text-align: right; font-size: larger;">In the last round, you returned <script>document.write(returned2)</script> out of <script>document.write(tripledAmount2)</script> coins to you and kept <script>document.write(dealerKept2)</script> coins.</p><p style="text-align: right; font-size: larger;">Your total in Round 2 was <script>document.write(dealerRound2)</script> coins, including your 10 coins starting credit.</p>
<p style="text-align: right; font-size: larger;"><b>Please wait until <i>The Investor</i> has made their decision on how much to invest into the shared pot in Round 3.</b></p>
<p style="text-align: right; font-size: larger;">
The invested amount will then be tripled automatically.&nbsp;</p><p style="text-align: right; font-size: larger;">You can then split it as you like between you and <i>The Investor.</i></p>
</div></div>
