  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage412361.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait412360.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
if (transfer1 == 0) {
    ...
    setTimeout(function() {
        let currentUrl = window.location.href;
        let newUrl = currentUrl.replace(/stage\d+/i, "stage412361");
        window.location.href = newUrl;
    }, 20000);
...
<p style="text-align: right; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer1)</script> coins </b>in this round.</p>
<p style="text-align: right; font-size: larger;">As part of the game, the amount was tripled to<b>&nbsp;<script>document.write(tripledAmount1)</script> coins for the shared pot.</b>
</p>
<p style="text-align: right; font-size: larger;"><i>The Investor</i> has currently <script>document.write(investorKept1)</script> coins left in this round.</p>
...
<h3 style="text-align: right;"><br></h3>
<h3 style="text-align: right;"><br></h3>
<div style="text-align: left;"><h1 style="text-align: right;">Part 1 | Round 1 of 3: Your turn!</h1>
<p style="text-align: right; font-size: larger;"><i>The Investor&nbsp;</i>has <b>invested <script>document.write(transfer1)</script> coin </b>in this round.</p>
<p style="text-align: right; font-size: larger;">As part of the game, the amount was tripled to <b><script>document.write(tripledAmount1)</script> coins for the shared pot.</b></p>
<p style="text-align: right; font-size: larger;"><i>The Investor</i> has currently <script>document.write(investorKept1)</script> coins left in this round.</p>
<p style="text-align: right; font-size: larger;">Now, it&#039;s your time to shine.</p>
<p style="text-align: right; font-size: larger;"><b>How much will you give back?</b></p>
</div></div>
...
<p style="text-align: right; margin-right: 100px;"><iframe src="https://botsi-trust-game-llama-2-13b-chat.hf.space" frameborder="0" width="1050" height="550" style="background-color: rgba(223, 240, 216, 0);"></iframe></p></div>
        ...
        <div class="col-sm-12" id="wrap10" style="display: none;"><div class="btnbox2"  style="vertical-align: middle;"><div class="form-group btnbox2 form-inline"><label style="margin-right: 15px" for="field10"><p style="font-size: larger;">You can give back&nbsp;<b style="color: rgb(247, 150, 70);">up to <script>document.write(tripledAmount1)</script> coins.</b></p></label><input name="10" id="field10"
                            ...
                            class="form-control input-lg" style="text-align: center;"><div id="field10_minmax" class=" messagefield10 alert alert-danger" style="display: none;">Please enter a number between 0 and <script>document.write(tripledAmount1)</script>.</div><div id="field10_noNumber" class="messagefield10 alert alert-danger" style="display: none;">Please enter a number. </div><div id="field10_tooManyDigits" class="messagefield10 alert alert-danger" style="display: none;">You entered too many digits.</div><div id="field10_notcorrect" class="messagefield10 alert alert-danger" style="display: none;">The value you entered is not correct.</div><script>var returned1=null;function checkValue_field10() {
        ...
        </script></div></div></div><script>if((role==2 && transfer1 > 0)) { $('#wrap10').show(); } </script><!-- END Element 10 Type: 20-->
        ...
        function checkFail() {}function toNextPage11() {showNext('wait412360.php?session_index=<?php echo $_SESSION[sessionID];?>&next=412361&jump=0',412361,412360)}</script></div><script>if((role==2 && transfer1 > 0)) { $('#wrap11').show(); $('#buttonclick11').addClass('buttonclick');} </script><!-- END Element 11 Type: 18-->
        
        </div><script>setInterval(function(){ if (role==2 && transfer1 == 0) $('#wrap5').show();if (!(role==2 && transfer1 == 0)) $('#wrap5').hide();if (role==2 && transfer1 > 0 && transfer1 != 1) $('#wrap7').show();if (!(role==2 && transfer1 > 0 && transfer1 != 1)) $('#wrap7').hide();if (role==2 && transfer1 == 1) $('#wrap8').show();if (!(role==2 && transfer1 == 1)) $('#wrap8').hide();if (role==2 && transfer1 > 0) $('#wrap9').show();if (!(role==2 && transfer1 > 0)) $('#wrap9').hide();if (role==2 && transfer1 > 0) $('#wrap10').show();if (!(role==2 && transfer1 > 0)) $('#wrap10').hide();if (role==2 && transfer1 > 0) $('#wrap11').show();if (!(role==2 && transfer1 > 0)) $('#wrap11').hide(); }, 100);</script><script>countdownTimer(TimeOut, 'stage412375.php?session_index=<?php echo $_SESSION[sessionID];?>',true);</script></form></div></div></body></html>