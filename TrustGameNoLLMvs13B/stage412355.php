  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage412356.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait412355.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
<div style="text-align: left;">
  ...
  <p style="font-size: larger;">The switch will happen automatically. <br><strong><u>You cannot choose or change your role.</u></strong></p>
        ...
        function checkFail() {} function toNextPage3() {
            if (loopEnd==412355) { showNext('wait412355.php?session_index=<?php echo $_SESSION[sessionID];?>',412356,412355);}
            else {showNext('stage412356.php?session_index=<?php echo $_SESSION[sessionID];?>',412356,412355);}
