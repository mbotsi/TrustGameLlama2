  ...
  p {
      font-size: 16px; /* Reduce paragraph font size for smaller devices */
        ...
        function skipStage(proceedifpossible) {
         ...
         if (proceedifpossible) location.replace('stage412375.php?session_index=<?php echo $_SESSION[sessionID];?>');
         else location.replace('wait412374.php?session_index=<?php echo $_SESSION[sessionID];?>');
        }
...
function executeAfterTime() {
    ...
    setTimeout(() => {
        ...
        var winningUrl = "https://app.prolific.com/submissions/complete?cc=CLNL9TDW";
        var completionUrl = "https://app.prolific.com/submissions/complete?cc=C139ZDJ1";
